...
public class RecruitEndService implements RecruitEndUseCase {
    ...
    @Override
    @Transactional
    public void endRecruitment(Long studyGroupId, Long currentMemberId) {

        StudyGroup studyGroup = groupRepository.findById(studyGroupId).orElseThrow(() -> new RuntimeException("해당 그룹이 없습니다."));
        studyGroup.endRecruitment(currentMemberId);
